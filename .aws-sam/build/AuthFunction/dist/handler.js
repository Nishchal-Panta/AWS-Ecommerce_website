    ...
    try {
        ...
        if (method === "POST") {
         ...
         ON DUPLICATE KEY UPDATE
           ...
           family_name=VALUES(family_name), updated_at=CURRENT_TIMESTAMP`, [(0, crypto_1.randomUUID)(), sub, email, given_name, family_name]);
        ...
        if (method === "GET") {
            ...
            if (!rows.length)
                return (0, shared_1.response)(404, { error: "User not found" });
